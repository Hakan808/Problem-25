...
export default function LandingPage() {
  ...
  return (
    <div className={`${dark ? "bg-black" : "bg-white"} transition duration-500 `}>
      <button
        onClick={handleDark}
        className={`m-4 rounded-md px-4 font-semibold transition duration-500   py-2 border border-2 ${dark ? "text-black border-black bg-white":"text-white bg-black border-black-"}`}
      >
        {dark ? "Gündüz" : "Gece"}
      </button>
      <div
      ...
      >
        ...
        >
          <div
            className={`${dark ? "bg-black":"relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"} `}
            style={{
              clipPath:
        ...
        <div className={`py-24 sm:py-32 transition duration-500 ${dark ? "bg-black" : "bg-wite"}`}>
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h1 className={`text-4xl transition duration-500 font-bold tracking-tight text-gray-900 sm:text-6xl ${dark ? "text-white" : "text-black"}`}> 
                Hoş geldiniz
              </h1>
              ...
              <div className="mt-10 flex items-center justify-center">
                <button
                  onClick={goToPricing}
                  className={`rounded-md  px-4 py-3 text-base font-semibold  shadow-sm hover:bg-indigo-500 focus-visible:outline-2 transition duration-500 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ${dark ? "text-black bg-white" : "text-white bg-indigo-600"}`}
                >
      ...
      <div className={`py-24 transition duration-500 ${dark ? "bg-black" : "bg-white"}`}> 
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className={`text-base font-semibold leading-7 text-indigo-600 ${dark ? "text-white" : "text-indigo-600"}`}>
              Fiyatlandırma
            </h2>
            <p className={`mt-2 text-4xl font-bold tracking-tight sm:text-5xl transition duration-500 ${dark ? "text-indigo-500" : "text-gray-900 "}`}>
              Her büyüklükteki&nbsp;ekip&nbsp;için fiyatlandırma planları
            </p>
          </div>
          <p className={`mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600 transition duration-500 ${dark ? "text-indigo-200": "text-gray-600"}`}>
          ...
          >
            <div className="flex flex-col justify-center rounded-3xl bg-white p-8 ring-1 ring-gray-200 xl:p-10 lg:z-10 lg:rounded-b-none">
              ...
              <a
                href="#"
                onClick={handleTop}
                className="mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 
